...
import stripe
from fastapi import status, UploadFile, File, APIRouter
...
@router.get("/user-info", response_model=UserDetails)
...
@router.get("/profile_seller/{user_id}", response_class=HTMLResponse)
...
@router.get("/api/profile_seller/{user_id}", response_class=JSONResponse)
...
@router.post("/update-sale", response_class=JSONResponse)
...
@router.get("/profile_customer/{user_id}", response_class=HTMLResponse)
...
@router.get("/api/profile_customer/{user_id}", response_class=JSONResponse)
...
@router.get("/mens-shoes", response_class=HTMLResponse)
@router.get("/mens-shoes/{page}", response_class=HTMLResponse)
...
@router.get("/womens-shoes", response_class=HTMLResponse)
@router.get("/womens-shoes/{page}", response_class=HTMLResponse)
...
@router.get("/kids-shoes", response_class=HTMLResponse)
@router.get("/kids-shoes/{page}", response_class=HTMLResponse)
...
@router.post("/new-product", response_class=HTMLResponse)
...
@router.post("/update-products", response_class=JSONResponse)
...
@router.post("/cart", response_class=JSONResponse)
...
@router.post("/cart/items", response_class=JSONResponse)
...
@router.post("/cart/items/update", response_class=JSONResponse)
...
@router.post("/cart/items/details", response_class=JSONResponse)
...
@router.get("/api/admin", response_class=JSONResponse)
...
@router.post("/update-stock", response_class=JSONResponse)
...
@router.post("/activate-product", response_class=JSONResponse)
...
@router.get("/ship", response_model=DeliveryDetailsSchema)
